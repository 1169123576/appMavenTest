...
public class FtpUtils {
	...
	public void initFtpClient() {
		...
		try {
			...
			BufferedReader bufferedReader = new BufferedReader(new FileReader(
					"ftpUtils-config.properties"));
			System.out.println(bufferedReader);
			properties.load(bufferedReader);
			// 获取key对应的value值
			String HOSTNAME = null, PORT = null, USERNAME = null, PASSWORD = null;
			//hostname = properties.getProperty(HOSTNAME);
			hostname ="119.29.173.247";
			...
			System.out.println("connecting...ftp服务器:" + this.hostname + ":"
					+ this.port);
			/*
			 * HOSTNAME=119.29.173.247 PORT=21 USERNAME=ROOT PASSWORD=to8to123
			 */
	...
	public static void main(String[] args) {
		...
		ftp.uploadFile("home/ftpuser1", "123.docx", "E://123.docx");
